...
## 🤖 ChatPaat — AI Chatbot Platform

**Tech Stack:** `FastAPI` `Next.js` `PostgreSQL` `SQLAlchemy` `JWT` `Redis` `AI APIs`

An AI-powered multi-user chatbot platform built around a modern asynchronous backend architecture.
...
**Tech Stack:** `FastAPI` `Apache Kafka` `Redis Streams` `gRPC` `Docker`

A distributed backend architecture demonstrating event-driven communication and asynchronous processing.
...
### 💡 Building Backends. Designing Systems. Exploring AI.
